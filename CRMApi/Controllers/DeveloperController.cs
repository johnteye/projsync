...
namespace CRMApi.Controllers
{
    ...
    [ApiController]
    public class DeveloperController(DeveloperDbContext context) : ControllerBase
    {
        private readonly DeveloperDbContext _context = context;
       ...
       [HttpPost]
        ...
        public async Task<IActionResult> UpdateDeveloper(int id,  DeveloperDTO UpdatedDeveloperDTO)
        {
            try
            {
                ...
                Developer.Gender = UpdatedDeveloperDTO.Gender;
