...
import {FiMenu, FiLayout, FiCalendar, FiCopy, FiMail, FiSettings, FiLogOut } from "react-icons/fi";
    ...
    <div className="w-[80%] h-full py-5 flex flex-col items-center">
      ...
      <div className="flex flex-col space-y-2.5 w-full ">
        ...
        <div className="flex h-10 w-full hover:bg-gray-400 items-center">
          ...
          <p className="font-manrope text-gray-500 font-normal text-sm">Groups</p>{" "}
        </div>
        <div className="flex h-10 w-full hover:bg-gray-400 items-center">
          <FiCalendar className="text-projsync-gray text-sm mx-3" />
          <p className="font-manrope text-gray-500 font-normal text-sm">Projects</p>
        </div>
        <div className="flex h-10 w-full hover:bg-gray-400 items-center">
          <FiCopy className="text-projsync-gray text-sm mx-3" />
          <p className="font-manrope text-gray-500 font-normal text-sm">Documents</p>
        </div>
        <div className="flex h-10 w-full hover:bg-gray-400 items-center">
          <FiMail className="text-projsync-gray text-sm mx-3" />
          <p className="font-manrope text-gray-500 font-normal text-sm">Messages</p>
        </div>
      </div>
      ...
      <footer className="flex flex-col sm:mt-40  w-full ">
        ...
        <div className="flex h-10 w-full bg-[#254568] items-center ">
          ...
          <p className="font-manrope text-white font-normal text-sm">
          Log out
          </p>
          </div>
      </footer>
